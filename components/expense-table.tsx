                        ...
                        >
                          ...
                          <TableCell className="py-3">
                            <motion.div whileHover={{ scale: 1.05 }} transition={{ duration: 0.15 }}>
                              <Badge
                                variant="secondary"
                                className="border-destructive/20 bg-destructive/10 text-[11px] font-medium text-destructive hover:bg-destructive/15"
                              >
                                {entry.category}
                              </Badge>
                            </motion.div>
                          ...
                          <TableCell className="py-3 text-right text-sm font-semibold text-destructive">
